...
dependencies {
    ...
    implementation("me.lucyy:squirtgun-api:2.0.0-pre4-SNAPSHOT")
    implementation("me.lucyy:squirtgun-bukkit:2.0.0-pre4-SNAPSHOT")
    implementation("me.lucyy:squirtgun-commands:2.0.0-pre4-SNAPSHOT")
